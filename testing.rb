leapyear = ["1600", "1604", "1608", "1612", "1616", "1620", "1624",
 ...
 begin
	...
	if (yearz.to_i > Time.now.year) #Does not allow a year that has not come yet
		puts "Must give a year that is before #{Time.now.year + 1}."
	end	
end until (yearz.to_i <= Time.now.year and yearz.length == 4 and yearz != 0)

if leapyear.include?(yearz)
	puts "#{yearz} is a leap year"
end
